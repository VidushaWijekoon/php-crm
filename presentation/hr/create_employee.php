                    ...
                    <div class="col-md-6">
                        ...
                        <fieldset class="mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="w-100" placeholder="Old Passport if necessory" name="old_passport">
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Current Passport <span style="color: red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="text" class="w-100" required placeholder="Current Passport" name="current_passport">
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Passport Expiring <span style="color: red">*</span></label>
                                <div class="col-sm-8">
                                    <input type="date" class="w-100" id="passport_expiring_date" name="passport_expiring_date" required />
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="w-100" id="visa_expiring_date" name="visa_expiring_date" required />
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <fieldset class="mt-2 mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="w-100" placeholder="Current Address" name="current_address">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="w-100" placeholder="Permanent Address" name="permanent_address">
                                </div>
                            </div>

                            <div class="row">
                                <label class="col-sm-4 col-form-label">Resident Country <span style="color: red">*</span></label>
                                <div class="col-sm-8">
