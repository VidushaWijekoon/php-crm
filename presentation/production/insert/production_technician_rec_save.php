...
if($exist ==0){
     ...
     echo '<script type="text/javascript">';
        ...
        echo 'window.location.href = "../production_technician_dashboard.php";';
        echo '</script>';
...
//Already scann msg alert
        ...
        header("Location: ../production_technician_dashboard.php");
    }
...
$query_run = mysqli_query($connection,$sql);
header("Location: ../production_technician_dashboard");
}
}
?>