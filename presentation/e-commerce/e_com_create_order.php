                    ...
                    <div class="col-9">
                        <div class="platformes">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="platform" id="alsakb" value="none"
                                    onclick="">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="platform" id="noon" value="One"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="platform" id="cartlaw" value="Two"
                                    onclick="setCartLawShippingMethod()">
                    ...
                    <div class="row px-5 mt-2">
                        <div class="col-sm-12 col-lg-5">
                            <div class="row">
                                ...
                                <div class="inputSec col-9">
                                    <select class="DropDown" name="keybord_language" id="keybord_language" onchange=""
                                        required>
                        ...
                        <div class="col-sm-12 col-lg-5">
                            <div class="row">
                                ...
                                <div class="inputSec col-9">
                                    <select class="DropDown" name="keybord_backlight" id="keybord_backlight" onchange=""
                                        required>
